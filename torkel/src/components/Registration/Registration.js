...
export default function Registration() {
    ...
    const handleChange = (event) => {
        context.setState({registrationForm: {...context.registrationForm, [event.target.id]: event.target.value}})
    }
    ...
    return (
        <div>
            ...
            <form id='registration_form' onSubmit={ submitForm }>
                ...
                <input value={context.registrationForm.first_name} id='first_name' className='formInput' type='string' onChange={ handleChange } />

                <p id='lastName'>Last Name:</p>
                <input value={context.registrationForm.last_name} id='last_name' className='formInput' type='string' onChange={ handleChange } />
                
                <p id='emailInput'>Email:</p>
                <input value={context.registrationForm.email} id='email' className='formInput' type='string' onChange={ handleChange } />
                
                <p id='passwordInput'>Password:</p>
                <input value={context.registrationForm.password} id='password' className='formInput' type='string' onChange={ handleChange } />
                ...
                <ul>
                    <p>
                        <input className='formCheckbox' id='formTermsOfServiceCheckbox' type='checkbox' />
